...
var IniciarWeb = {
    ...
    got_to: function got_to() {
        var $objetos = (0, _jquery2.default)("[data-goto]");
        $objetos.on('click', function () {
            var goto = (0, _jquery2.default)(this).data('goto');
            if (!!goto) {
                var $nuevoScroll = (0, _jquery2.default)(goto);
...
var Menu = {
    init: function init() {
        //Menu movil
        (0, _jquery2.default)('.MenuFlat--abrirMenu,#MenuFlat').on('click', function () {
...
var _Menu = require('./helpers/Menu');
...
},{"./helpers/Alerta":1,"./helpers/IniciarWeb":2,"./helpers/Menu":3}],5:[function(require,module,exports){
/*!
